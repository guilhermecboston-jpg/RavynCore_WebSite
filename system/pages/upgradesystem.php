...
echo '<div class="rc-st-page rc-upg-page">'
    ...
    . '<h3>Taxas de Sucesso por Nível</h3>'
    . '<div class="rc-st-table-center rc-upg-table-center rc-upg-table-center--lg">'
    ...
    . '<div class="rc-st-table-center rc-upg-table-center rc-upg-table-center--md">'
    . '<div class="rc-bf-table-wrap rc-tier-table-wrap">'
    . '<table class="rc-bf-table rc-tier-table rc-upg-table">'
    ...
    . '<div class="rc-st-table-center rc-upg-table-center rc-upg-table-center--sm">'
    . '<div class="rc-bf-table-wrap rc-tier-table-wrap">'
    . '<table class="rc-bf-table rc-tier-table rc-upg-table">'
    ...
    . '<div class="rc-st-table-center rc-upg-table-center rc-upg-table-center--xl">'
    . '<div class="rc-bf-table-wrap rc-tier-table-wrap">'
