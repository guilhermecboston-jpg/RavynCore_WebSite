...
echo '<div class="rc-st-page rc-hf-page">'
    ...
    . '<p class="rc-hf-lead">Ao utilizar o <span class="rc-hf-highlight">HuntFinder</span>, o jogador poderá:</p>'
    . '<ul class="rc-st-notes rc-hf-rules-list">' . $featuresHtml . '</ul>'
    . '</section>'

    . '<section class="rc-st-card rc-hf-anchor" id="rc-hf-dificuldade">'
    . '<h3>Dificuldades</h3>'
    . '<p class="rc-hf-lead">Filtre as hunts pelo nível de <span class="rc-hf-highlight">dificuldade</span> no menu superior da janela do HuntFinder.</p>'
    ...
    . '<p class="rc-hf-lead">Alguns respawns possuem mais de uma localização. Ao abrir os <span class="rc-hf-highlight">detalhes</span> de uma hunt, selecione a instância desejada antes de teleportar.</p>'
    . '<div class="rc-bf-table-wrap"><table class="rc-bf-table rc-tier-table rc-hf-table">'
    ...
    . '<p class="rc-hf-note">' . $data['return_note'] . '</p>'
    . '</div>'
    . ($teleportBackImgHtml !== ''
        ? '<figure class="rc-hf-teleport-wrap">' . $teleportBackImgHtml . '<figcaption>Teleport de retorno (<span class="rc-hf-highlight">sem PZ</span>)</figcaption></figure>'
        : '')
    . '</div></section>'
