...
echo '<div class="rc-st-page rc-tier-page">'
    ...
    . '<li>Remover o <span class="rc-tier-highlight">Tier</span> antes de uma nova tentativa de upgrade;</li>'
    . '<li>Vender o item sem o <span class="rc-tier-highlight">Tier</span> aplicado;</li>'
    . '<li>Alterar sua build ou estilo de jogo;</li>'
    . '<li>Reaproveitar seus <span class="rc-tier-highlight">Tiers</span> em outros equipamentos.</li>'
    . '</ul>'
    ...
    . '<ul class="rc-st-notes">'
    . '<li>O <span class="rc-tier-highlight">Tier</span> é removido do equipamento;</li>'
    . '<li>O item original é enviado para a <strong>Store Inbox</strong> sem Tier;</li>'
    . '<li>O <span class="rc-tier-highlight">Tier</span> removido é entregue na sua <strong>Store Inbox</strong> como um item.</li>'
    . '</ul>'
    . '</section>'

    . '<section class="rc-st-card rc-tier-anchor" id="rc-tier-aplicacao">'
    . '<h3>Como Funciona a Aplicação?</h3>'
    . '<p>Ao utilizar um <span class="rc-tier-highlight">Tier</span> em um equipamento:</p>'
    . '<ul class="rc-st-notes">'
    . '<li>O <span class="rc-tier-highlight">Tier</span> é aplicado normalmente;</li>'
    ...
    . '<ul class="rc-st-notes">'
    . '<li>O <span class="rc-tier-highlight">Tier</span> nunca é perdido durante a extração;</li>'
    . '<li>É possível extrair e reaplicar <span class="rc-tier-highlight">Tiers</span> quantas vezes desejar;</li>'
